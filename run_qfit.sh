...
PDB_file=/wynton/home/fraserlab/jessicaflowers/survey_true_pos/elife_qfit_inputs.txt
...
source activate qfit_feb13
which python
export PHENIX_OVERWRITE_ALL=true
source /wynton/home/fraserlab/jessicaflowers/phenix/phenix-1.20.1-4487/phenix_env.sh

#________________________________________________PARSE INPPUT FILE________________________________________________#
...
command="qfit_ligand composite_omit_map.mtz -nc 9000 -sm '${smiles}' -l 2FOFCWT,PH2FOFCWT ${pdb_id}_001.pdb ${chain_res}"
