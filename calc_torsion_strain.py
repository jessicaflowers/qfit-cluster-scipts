...
pdb_files = glob.glob(os.path.join(args.path, f'{args.conf_type}.pdb'))

# Debug: print found conf_type_ligand_*.pdb files
print(f"Found {args.conf_type}.pdb files: {pdb_files}")
...
for pdb_file in pdb_files:
    ...
    try:
        ...
        # Extract the first numerical value (energy) from the CSV file
...
if energy_data:
    ...
    final_csv_path = os.path.join(args.output_dir, f'{args.conf_type}_strain.csv')
